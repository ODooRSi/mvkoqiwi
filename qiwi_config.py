...
bot = telebot.TeleBot('1876072134:AAGZcAcSsXjKzEHHjMfCTz_lvUQw-uavd5Y')  # токен бота

admin = [743885319] # айди одменов

amount = 50  # цена доступа

phone = '79658810687 ' # твой номер телефона qiwi

token = 'f4568c946c197deb6222d0db49485b11' # твой токен кошелька киви
...
def remove_sub(message):
    try:
        ...
        bot.send_message(message.from_user.id,
                         "Упс... что-то пошло не так, проверьте правильность заданных данных. Помощь: @mvk0o")
        print(e)
...
def pay_many(message):
    try:
        ...
        bot.send_message(message.from_user.id, "Упс... что-то пошло не так, проверьте правильность заданных данных. Помощь: @mvk0o")
        print(e)
